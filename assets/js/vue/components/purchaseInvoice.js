    ...
    methods:{
        ...
        getCurrentBranch() {
            axios.get('/get_current_branch').then(res => {
                ...
                this.companyId = res.data.Company_SlNo;
            })
        },
        setStyle(){
                ...
                <body>
                    <div class="container">
                        <div class="row" style="text-align:center;margin-top: 20px;">
                            ...
                            <div class="col-xs-10" style="padding-top:0px;position: relative;left: 34%;transform: translateX(-50%);">
