...
<div class="row">
	...
	<div class="form-horizontal">
		...
		<div class="form-group">
			...
			<div class="form-group">
			<label class="col-sm-4 control-label" for="ec_email">Education 
			 qualification </label>
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
				<input type="text" id="ec_edu" name="ec_edu" placeholder="Education Qualification" class="form-control" value="<?php echo $selected->edu_qua; ?>" />
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-4 control-label" for="ec_email"> 
			 Previous Due </label> 
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
				<input type="text" autocomplete="off" id="previous_due" name="previous_due" value="<?php echo $selected->previous_due;?>"  placeholder="previous due" class="form-control" />
			</div> 
		</div>
		<div class="form-group">
			...
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
				<input type="file"  id="documents" name="documents" class="form-control" onchange="readURL(this)" style="height:35px" />
			</div>
		</div>
...
<script type="text/javascript">
    function Employee_submit(){
        ...
        var fd = new FormData();
          ...
          fd.append('documents', $('#documents')[0].files[0]);
          fd.append('ec_edu', $('#ec_edu').val());
		  ...
		  fd.append('previous_due', $('#previous_due').val());
