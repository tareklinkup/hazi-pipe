				...
				<div class="widget-main">
					...
					<div class="row">
						<div class="col-sm-5">
							...
							<div class="form-group">
								<label class="col-sm-4 control-label no-padding-right"> Owner name  </label>
								<div class="col-sm-8">
									<input type="text" id="ownerName" readonly placeholder="Owner Name" class="form-control" v-model="selectedCustomer.owner_name"  />
								</div>
							</div>
						...
						<div class="col-sm-5">
							<form v-on:submit.prevent="addToCart">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="salesRate" placeholder="Rate" step="0.01" class="form-control" v-model="selectedProduct.Product_SellingPrice" v-on:input="productTotal"/>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right" v-if="currentBranch == 2">Qty</label>
									<label class="col-sm-3 control-label no-padding-right" v-else> Feet </label>
									<div class="col-sm-9">
										<input type="text" id="quantity" placeholder="PCS / Feet" class="form-control" ref="quantity" v-model="selectedProduct.quantity" v-on:input="productTotal" autocomplete="off" required/>
									</div>
								</div>
								...
								<div class="form-group" style="display: none">
									<label class="col-sm-3 control-label no-padding-right"> Size (ft) </label>
									<div class="col-sm-9">
										<input type="text" id="totalSize" placeholder="Total Size" class="form-control" v-model="selectedProduct.totalSize" v-on:input="sizeToQty" />
									</div>
								</div>
								<div class="form-group">
				...
				<table class="table table-bordered" style="color:#000;margin-bottom: 5px;">
					<thead>
						<tr class="">
							...
							<th style="width:7%;color:#000;">{{currentBranch == 2 ? 'Qty': 'Feet' }}</th>
									...
									<tr>
										<td>
											<div class="form-group">
												...
												<div class="col-sm-12">
													<input type="text" id="subTotal" class="form-control" v-model="sales.subTotal" readonly />
												</div>
											</div>
										</td>
									</tr>
									...
									<tr>
										<td>
											<div class="form-group">
												...
												<div class="col-sm-4">
													<input type="text" id="vatPercent" class="form-control" v-model="vatPercent" v-on:input="calculateTotal"/>
												</div>
												<label class="col-sm-1 control-label no-padding-right">%</label>
												<div class="col-sm-7">
													<input type="text" id="vat" readonly="" class="form-control" v-model="sales.vat"/>
												</div>
											</div>
										</td>
									</tr>
									...
									<tr>
										<td>
											<div class="form-group">
												...
												<div class="col-sm-4">
													<input type="text" id="discountPercent" class="form-control" v-model="discountPercent" v-on:input="calculateTotal"/>
												</div>

												<label class="col-sm-1 control-label no-padding-right">%</label>

												<div class="col-sm-7">
													<input type="text" id="discount" class="form-control" v-model="sales.discount" v-on:input="calculateTotal"/>
												</div>
									...
									<tr>
										<td>
											<div class="form-group">
												...
												<div class="col-sm-12">
													<input type="text" class="form-control" v-model="sales.transportCost" v-on:input="calculateTotal"/>
												</div>
											</div>
										</td>
									</tr>
									...
									<tr style="display:none;">
										<td>
											<div class="form-group">
												...
												<div class="col-sm-12">
													<input type="text" id="roundOf" class="form-control" />
												</div>
											</div>
										</td>
									</tr>
									...
									<tr>
										<td>
											<div class="form-group">
												...
												<div class="col-sm-12">
													<input type="text" id="paid" class="form-control" v-model="sales.paid" v-on:input="calculateTotal" v-bind:disabled="selectedCustomer.Customer_Type == 'G' ? true : false"/>
												</div>
											</div>
										</td>
									</tr>
									...
									<tr>
										<td>
											<div class="form-group">
												...
												<div class="col-sm-6">
													<input type="text" id="due" class="form-control" v-model="sales.due" readonly/>
												</div>
												<div class="col-sm-6">
													<input type="text" id="previousDue" class="form-control" v-model="sales.previousDue" readonly style="color:red;"  />
												</div>
											</div>
										</td>
									</tr>
	...
	new Vue({
		...
		methods:{
			...
			productTotal(){
				...
				// let calPerFeet = 0;
				// if (this.selectedProduct.size>this.selectedProduct.Product_SellingPrice) {
                //    calPerFeet = this.selectedProduct.size/this.selectedProduct.Product_SellingPrice
				// }else{
                //     calPerFeet = this.selectedProduct.Product_SellingPrice/this.selectedProduct.size;
				// }
				// this.selectedProduct.total = parseFloat(calPerFeet*this.selectedProduct.quantity).toFixed(2);
				this.selectedProduct.totalSize = parseFloat(this.selectedProduct.quantity);
			...
			sizeToQty(){
				let calPerQty = 0;
				this.selectedProduct.quantity = this.selectedProduct.totalSize / this.selectedProduct.size;
				this.selectedProduct.total = (parseFloat(this.selectedProduct.totalSize) * parseFloat(this.selectedProduct.Product_SellingPrice)).toFixed(2);
				if(this.productStock < this.selectedProduct.totalSize){
					alert("Stock Limit");
					this.selectedProduct.quantity = 0;
					this.selectedProduct.totalSize = 0;
				}
			},
			onSalesTypeChange(){
			...
			addToCart(){
				let product = {
					...
					totalSize: this.selectedProduct.totalSize,
			...
			saveSales(){
				// alert(this.selectedEmployee.Employee_SlNo);
				// return false;
				if(this.selectedCustomer.Customer_SlNo == ''){
			...
			getSales(){
				axios.post('/get_sales', {salesId: this.sales.salesId}).then(res=>{
					...
					this.selectedCustomer = {
						...
						employee_id: sales.customer_employee_id,
