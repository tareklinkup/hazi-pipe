...
<div class="row">
	...
	<div class="form-horizontal">
		...
		<div class="form-group">
			...
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
				<input type="text" id="ec_edu" name="ec_edu" placeholder="Education Qualification" class="form-control" />
			</div>
		</div>
		<div class="form-group">
			...
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
				<input type="text" autocomplete="off" id="previous_due" name="previous_due" placeholder="previous due" class="form-control" />
			</div>
		</div>
