		...
		<div class="row" style="margin-top: 10px;margin-bottom:15px;border-bottom: 1px solid #ccc;padding-bottom:15px;">
			...
			<div class="col-md-5">
				<div class="form-group clearfix">
					...
					<div class="col-md-7">
						<input type="text" class="form-control" v-model="customer.cheque_number">
					</div>
				</div>
				...
				<div class="form-group clearfix">
					...
					<div class="col-md-7">
						<input type="number" step="0.01" class="form-control" v-model="customer.previous_due" required>
					</div>
				</div>
		...
		data(){
			return {
				...
				columns: [
                    ...
                    { label: 'Cheque Number', field: 'cheque_number', align: 'center' },
