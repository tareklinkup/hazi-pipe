<?php
	$companyInfo = $this->db->query("select * from tbl_company c where c.company_BrunchId= ? order by c.Company_SlNo desc limit 1", $this->session->userdata('BRANCHid'))->row();
?>
			...
			<div class="navbar-container ace-save-state" id="navbar-container">
				...
				<div class="navbar-header pull-left">
					<a href="<?php echo base_url(); ?>" class="navbar-brand">
						<small>
							...
							<?php echo $companyInfo->Company_Name;?> <span style="color:#000;font-weight:700;letter-spacing:1px;font-size:16px;"> <?php //echo $this->session->userdata('Brunch_name'); ?> </span>
						</small>
					</a>
				</div>
				...
				<div class="navbar-buttons navbar-header pull-right" role="navigation">
					<ul class="nav ace-nav">
						...
						?>
						<li><a href="<?= base_url()?>re_order_list">Re-Order List</a></li>
