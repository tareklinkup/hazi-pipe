					...
					<div class="row">
						<div class="col-sm-5">
							<div class="form-group clearfix">
								...
								<div class="col-sm-8">
									<input type="text" class="form-control" v-model="quotation.customerName" placeholder="Customer/Company Name" required>
								</div>
							</div>
						...
						<div class="col-sm-5">
							<form v-on:submit.prevent="addToCart">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" placeholder="Qty" class="form-control" style="float: left; width: 40%;" ref="quantity" v-model="selectedProduct.quantity" autocomplete="off" @input="sftTotal" required/>
										 <span style="margin: 3px;">Sft</span> 
										<input type="text" class="form-control" style="float:right; width: 50%;"  placeholder="0"   v-model="selectedProduct.Size"  autocomplete="off" required/>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"> Size(Fit) </label>
									<div class="col-sm-9">
										<input type="text"  placeholder="0" class="form-control"  v-model="selectedProduct.sftTotal"autocomplete="off" required/>
									</div>
								</div>
				...
				<table class="table table-bordered" style="color:#000;margin-bottom: 5px;">
					<thead>
						<tr class="">
							...
							<th style="width:8%;color:#000;">sft</th>
...
<script>
	...
	new Vue({
		...
		methods:{
			...
			sftTotal(){
				this.selectedProduct.sftTotal = (parseFloat(this.selectedProduct.quantity) * parseFloat(this.selectedProduct.size)).toFixed(2);
				this.productTotal();
			},
			productTotal(){
				this.selectedProduct.total = (parseFloat(this.selectedProduct.sftTotal) * parseFloat(this.selectedProduct.Product_SellingPrice));
			},
			...
			addToCart(){
				let product = {
					...
					sftTotal: this.selectedProduct.sftTotal
