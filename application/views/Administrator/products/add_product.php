...
<div id="products">
		...
		<div class="row" style="margin-top: 10px;margin-bottom:15px;border-bottom: 1px solid #ccc;padding-bottom: 15px;">
			<div class="col-md-6">
				...
				<div class="form-group clearfix">
					<label class="control-label col-md-4">Size (feet)</label>
					<div class="col-md-7">
						<input type="number" step="0.01" class="form-control" v-model="product.size">
					</div>
				</div>
		...
		data(){
			return {
				...
				columns: [
                    ...
                    { label: 'Size (feet)', field: 'size', align: 'center' },
