		...
		<div class="row" style="padding-top:10px;">
			<div class="col-md-6">
				...
				<table class="table table-bordered table-condensed">
					...
					<tbody style="display:none;" v-bind:style="{display: receivedFromCustomers.length > 0 ? '' : 'none'}">
						<tr v-for="payment in receivedFromCustomers">
							...
							<td>{{ payment.CPayment_amount | decimal }}</td>
							<td>{{ payment.CPayment_notes }}</td> 
						</tr>
					</tbody>
					<tfoot>
						<tr style="font-weight:bold;">
				...
				<table class="table table-bordered table-condensed">
					<thead> 
						<tr style="background: #dee4dc;">
							<th colspan="7">Received from Suppliers</th>
						</tr> 
						<tr>
							<th>Invoice</th>
							<th>Date</th>
					...
					<tbody style="display:none;"  v-bind:style="{display: receivedFromSuppliers.length > 0 ? '' : 'none'}">
						<tr v-for="payment in receivedFromSuppliers">
							...
							<td>{{ payment.SPayment_amount | decimal }}</td>
							<td style="text-align:right;">{{ payment.SPayment_notes }}</td>
						</tr>
					</tbody>
					<tfoot>
						<tr style="font-weight:bold;">
				...
				<table class="table table-bordered table-condensed">
					...
					<tbody style="display:none;" v-bind:style="{display: cashReceived.length > 0 ? '' : 'none'}">
						<tr v-for="transaction in cashReceived">
							...
							<td>{{ transaction.In_Amount | decimal }}</td>
							<td style="text-align:right;">{{ transaction.Tr_Description }}</td>
						</tr>
					</tbody>
					<tfoot> 
						<tr style="font-weight:bold;">
				...
				<table class="table table-bordered table-condensed">
					<thead>
						<tr style="background: #dee4dc;">
							<th colspan="7">Bank Withdraws</th>
						</tr>
						<tr>
							<th>Sl</th>
							<th>Account Name</th>
					...
					<tbody style="display:none;" v-bind:style="{display: bankWithdraws.length > 0 ? '' : 'none'}">
						<tr v-for="transaction in bankWithdraws">
							...
							<td>{{ transaction.amount | decimal }}</td>
							<td style="text-align:right;">{{ transaction.note }}</td>
						</tr>  
					</tbody>  
					<tfoot>  
						<tr style="font-weight:bold;">
			...
			<div class="col-md-6">
				...
				<table class="table table-bordered table-condensed">
					<thead>
						<tr style="background: #dee4dc;">
							<th colspan="5">Paid to Suppliers</th>
						</tr>
						<tr>
							<th>Invoice</th>
							<th>Date</th>
				...
				<table class="table table-bordered table-condensed">
					<thead>
						<tr style="background: #dee4dc;">
							<th colspan="5">Paid to Customers</th>
						</tr> 
						<tr> 
							<th>Invoice</th> 
							<th>Date</th> 
					...
					<tbody style="display:none;" v-bind:style="{display: paidToCustomers.length > 0 ? '' : 'none'}">
						<tr v-for="payment in paidToCustomers">
							...
							<td>{{ payment.Customer_Name }}</td>
							<td>{{ payment.CPayment_amount | decimal }}</td>
							<td style="text-align:right;">{{ payment.CPayment_notes }}</td>
						</tr>
					</tbody>
					<tfoot>
						<tr style="font-weight:bold;">
				...
				<table class="table table-bordered table-condensed">
					<thead>
						<tr style="background: #dee4dc;">
							<th colspan="6">Employee Payments</th>
						</tr>
						<tr>
							<th>Employee Id</th>
							<th>Employee Name</th>
					...
					<tbody style="display:none;" v-bind:style="{display: employeePayments.length > 0 ? '' : 'none'}">
						<tr v-for="payment in employeePayments">
							...
							<td>{{ payment.payment_amount | decimal }}</td>
						</tr>
					</tbody>
					<tfoot>
						<tr style="font-weight:bold;">
