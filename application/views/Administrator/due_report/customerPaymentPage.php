				...
				<div class="row">
					<div class="col-md-5 col-md-offset-1">
						...
						<div class="form-group">
							...
							<div  style="display:none; " v-bind:style="{display: selectedCustomer.Customer_SlNo == 0 ? 'none' : 'block'}">
							<div class="form-group">
							<label class="col-md-4 control-label">Address</label>
							<label class="col-md-1">:</label>
							<div class="col-md-7">
								<input type="text" readonly class="form-control" v-model="selectedCustomer.Customer_Address">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<label class="col-md-1">:</label>
							<div class="col-md-7">
								<input type="text"  readonly class="form-control" v-model="selectedCustomer.Customer_Mobile">
							</div>
						</div>
						...
						<div class="form-group"> 
							...
							<label class="col-md-1">:</label>
							<div class="col-md-7">
								<input type="text" readonly class="form-control" v-model="selectedCustomer.owner_name">
							</div>
						</div>
							</div>
