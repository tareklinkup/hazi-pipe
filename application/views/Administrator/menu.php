			...
			<li class="">
				...
				<ul class="submenu">
					<?php if (array_search("salesinvoice", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
						...
						<li class="">
							<a href="<?php echo base_url(); ?>re_order_list">
								<i class="menu-icon fa fa-caret-right"></i>
								Re-Order List
							</a>
							<b class="arrow"></b>
					...
					<?php endif; ?>
						<!-- <?php if (array_search("salesinvoice", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
						<li class="">
							<a href="<?php echo base_url();?>emp_sale_record">
								<i class="menu-icon fa fa-caret-right"></i>
					...
					<?php endif; ?>
										<?php if (array_search("employee_sale_report", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>

						<li class="">
							<a href="<?php echo base_url(); ?>employee_sale_report">
								<i class="menu-icon fa fa-caret-right"></i>
